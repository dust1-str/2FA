...
<body class="flex items-center justify-center h-screen bg-gray-100">
    <div class="w-full max-w-xs">
        <form method="POST" action="{{ route('verifyOtp', ['id' => $id]) }}" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
            @csrf
            <div class="mb-4">
            ...
            <div class="flex items-center justify-between">
                ...
                <a href="{{ route('resendOtp', ['id' => $id]) }}" class="text-blue-500 hover:text-blue-700">Resend code</a>
            </div>
